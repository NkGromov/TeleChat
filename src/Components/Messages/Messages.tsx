...
const Mesages = () => {
    return (
        <MessagesList>
            <Item isMy={false}>Текст про что то чтобы держать в курсе а потом еще текст</Item>
            <Item isMy={false}>Текст про что то чтобы держать в курсе а потом еще текст</Item>
            <Item isMy={false}>Текст про что то чтобы держать в курсе а потом еще текст</Item>
            <Item isMy={false}>Текст про что то чтобы держать в курсе а потом еще текст</Item>
            <Item isMy={false}>Текст про что то чтобы держать в курсе а потом еще текст</Item>
            <Item isMy={false}>Текст про что то чтобы держать в курсе а потом еще текст</Item>
            <Item isMy={false}>Текст про что то чтобы держать в курсе а потом еще текст</Item>
            <Item isMy={true}>Текст про что то чтобы держать в курсе а потом еще текст</Item>
            <Item isMy={true}>
